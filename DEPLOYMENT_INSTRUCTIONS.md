# SidelineCEO - Vercel Postgres Deployment Instructions
...
Once deployed, your SidelineCEO app will be running on Vercel with a production Postgres database, ready to scale!
