...
// User and Session types moved to server-side only (Prisma schema)
// Authentication is now fully server-side with httpOnly cookies
...
export class StorageManager {
  ...
  // USERS_KEY and SESSION_KEY removed - auth is now server-side only
  ...
  // ===== USER & SESSION MANAGEMENT REMOVED =====
  // All authentication is now handled server-side via:
  // - /api/auth/signin - POST to login
  // - /api/auth/signup - POST to register
